            ...
            <div className="mid-sec-1">
               ...
               <div className="mid-sec-1-A">
                <div className="mid-sec-1-AA">
                  <img className="image-mid" src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1a/5f/cb/ed/caption.jpg?w=300&h=300&s=1" alt=""/>
                  <h2 className="content-1">Four-Day Private Luxury Golden</h2>
                  <h2 className="content-1">Triangle Tour to Agra And Jaipur</h2>
                  ...
                  <h2 className="price-tag">from ₹15,960 per adult </h2>
                </div>
                <div className="mid-sec-1-AA">
                <img className="image-mid" src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1a/97/0c/e8/caption.jpg?w=300&h=300&s=1" alt=""/>
                  <h2 className="content-1">Private Day Tour of Taj Mahal</h2>
                  <h2 className="content-1">and Agra Fort By Superfast Train</h2>
                  <h2 className="content-1">-All inclusive</h2>
                  <p className="dot-1"><GoPrimitiveDot className="dot"/>
                     <GoPrimitiveDot className="dot"/>
                     <GoPrimitiveDot className="dot"/>
                     <GoPrimitiveDot className="dot"/>
                  ...
                  <h2 className="price-tag">from ₹4,180 per adult </h2>
                </div>
                <div className="mid-sec-1-AA">
                <img className="image-mid" src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/21/71/c0/4d/caption.jpg?w=300&h=300&s=1" alt=""/>
                  <h2 className="content-1">5-Hour Private Mumbai</h2>
                  <h2 className="content-1">Sightseeing Tour</h2>
                  {/* <h2 className="content-1">From New Delhi</h2> */}
                  <p className="dot-1"><GoPrimitiveDot className="dot"/>
                     <GoPrimitiveDot className="dot"/>
                     <GoPrimitiveDot className="dot"/>
                  ...
                  <h2 className="price-tag">from ₹4,000 per adult </h2>
                </div>
                <div className="mid-sec-1-AA">
                <img className="image-mid" src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1a/5a/ea/82/caption.jpg?w=300&h=300&s=1" alt=""/>
                  <h2 className="content-1">All inclusive Day Trip to Taj</h2>
                  <h2 className="content-1">Mahal, Agra Fort and Baby Taj</h2>
                  <h2 className="content-1">From Delhi by Car</h2>
                  <p className="dot-1"><GoPrimitiveDot className="dot"/>
                     <GoPrimitiveDot className="dot"/>
                     <GoPrimitiveDot className="dot"/>
                     <GoPrimitiveDot className="dot"/>
                  ...
                  <h2 className="price-tag">from ₹4,612 per adult </h2>
                </div>
               </div>
            </div>
